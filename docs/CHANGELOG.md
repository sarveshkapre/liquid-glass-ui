...
## Unreleased
- CI workflows now run on `self-hosted` runners; Playwright install switched to `npx playwright install chromium` and runner prerequisites/setup are documented in `docs/PROJECT.md`.
